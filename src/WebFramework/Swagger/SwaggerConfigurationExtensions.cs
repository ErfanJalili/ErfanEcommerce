...
namespace WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            //We call this method for by reflection with the Startup type of entry assmebly (SkyCoach.Api assembly)
            var mainAssembly = Assembly.GetEntryAssembly(); // => SkyCoach.Api project assembly
            ...
            {
                var xmlDocPath = Path.Combine(AppContext.BaseDirectory, "SkyCoach.Api.xml");
